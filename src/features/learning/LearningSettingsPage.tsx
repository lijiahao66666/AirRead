...
export function LearningSettingsPage({ store, dailyMinutes, selectedModelId, storyProfile, storyMemory, packs, onMinutesChange, onModelChange, onStoryProfileChange, onChapterWordCountChange, onStartNewStory }: LearningSettingsPageProps) {
  ...
  const confirmNewStory = () => {
    ...
    setStoryActionMessage(selectedModelId
