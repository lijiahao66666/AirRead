...
- **免费 + 自带密钥**：内置免费翻译，默认自动按 MyMemory → Azure Edge → Google Translate 尝试；也可以在设置中选择单条免费线路。自定义服务分为“大语言模型翻译”（OpenAI Responses API、OpenAI Chat Completions 兼容协议、Anthropic Messages API）和“专用翻译 API”（腾讯云翻译 TMT、Azure AI Translator、有道智云文本翻译、DeepL API）。
