...
class BookParser {
  ...
  Future<EpubBookRef?> openBook(String filePath) async {
    throw UnsupportedError('openBook is not supported on Web');
  }
  ...
  Future<String?> openTxt(String filePath) async {
    throw UnsupportedError('openTxt is not supported on Web');
  }
  ...
  Future<ParsedMetadata> parse(String filePath) async {
    throw UnsupportedError('parse(filePath) is not supported on Web');
  }
}
